    ...
    <div class="grid gap-8 md:grid-cols-2">
      ...
      <div class="space-y-4">
        <div class="relative overflow-hidden rounded-lg bg-gray-100">
          <img src={data.image} loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />          
        </div>
      </div>
      ...
      <div class="md:py-8">
        ...
        <div class="mb-6 flex items-center gap-3 md:mb-10">
          ...
          <span class="text-sm text-gray-500 transition duration-100">{data.rating.count} ratings</span>
        </div>        
        ...
        <div class="mb-4">
          <div class="flex items-end gap-2">
            <span class="text-xl font-bold text-gray-800 md:text-2xl">${data.price}</span>            
          </div>
